        ...
        {featured ? (
          ...
          >
            ...
            <motion.div style={{ x: tickerX }} className="pointer-events-none absolute -left-10 top-2 flex gap-8 opacity-35">
              ...
              <span className="whitespace-nowrap text-[10px] uppercase tracking-[0.22em] text-emerald-200">Manual Work -80%</span>
            </motion.div>
            ...
            <div className="grid items-center gap-8 lg:grid-cols-[minmax(0,1fr)_320px]">
              <div>
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <span className="rounded-full border border-sky-200/20 bg-sky-200/8 px-2.5 py-0.5 text-[10px] text-sky-300/80">
                    {featured.date}
                  </span>
                </div>
                ...
                <p className="mt-3 text-sm font-medium text-emerald-300/90">{featured.impact}</p>
                ...
                <div className="mt-5 flex flex-wrap gap-3">
                  ...
                  {featured.live ? (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="rounded-lg border border-emerald-200/35 bg-emerald-200/12 px-3 py-2 text-sm font-medium text-emerald-100 transition duration-300 hover:-translate-y-0.5 hover:border-emerald-200/55 hover:bg-emerald-200/22"
                    >
                      Live Demo
                    </a>
                  ) : null}
              ...
              <div className="block [perspective:1400px]">
                <div className="relative mx-auto h-[310px] w-[220px] sm:h-[340px] sm:w-[250px]">
                  ...
                  >
                    <p className="text-[10px] uppercase tracking-[0.2em] text-slate-400">AI Signal</p>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {rest.map((project, index) => (
            <motion.article
              ...
              className="group relative overflow-hidden rounded-2xl border border-white/12 bg-gradient-to-br from-white/[0.04] via-zinc-900 to-zinc-900 p-5 shadow-[0_0_0_1px_rgba(255,255,255,0.02)] transition-colors duration-300 hover:border-white/25"
            >
              <motion.div
                className="pointer-events-none absolute inset-0 opacity-0 transition-opacity duration-300 group-hover:opacity-100"
                style={{ background: "radial-gradient(circle at 30% 30%, rgba(56,189,248,0.05) 0%, transparent 60%)" }}
              />
              <div className="flex items-start justify-between gap-2">
                <p className="text-xs uppercase tracking-[0.18em] text-slate-500">Project</p>
                <span className="rounded-full border border-white/8 px-2 py-0.5 text-[10px] text-slate-500">
                  {project.date}
                </span>
              </div>
              ...
              <p className="mt-2 text-xs font-medium text-emerald-400/80">{project.impact}</p>
              <div className="mt-3 flex flex-wrap gap-1.5">
                {project.stack.map((tech) => (
                  <span key={tech} className="rounded-md border border-white/10 bg-white/[0.03] px-2 py-1 text-xs text-slate-300">
                    {tech}
                  </span>
                ))}
              </div>
              <div className="mt-4 flex flex-wrap gap-2.5">
                ...
                {project.live ? (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex rounded-lg border border-emerald-200/30 bg-emerald-200/10 px-3 py-2 text-sm text-emerald-100 transition duration-300 hover:-translate-y-0.5 hover:border-emerald-200/50 hover:bg-emerald-200/18"
                  >
                    Live Demo
                  </a>
                ) : null}
